...
export const createForm = (name, data) => {
    ...
    let {id, title, firstName, lastName, gender, email, dateOfBirth, phone, picture} = data
...
export const mapUserToView = ({id, title, firstName, lastName, gender, email, dateOfBirth, phone, picture, location}) => {
